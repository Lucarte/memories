...
return [
    ...
    */
    ...
    'meilisearch' => [
        ...
        'key' => env('MEILISEARCH_KEY'), // Use the MEILISEARCH_MASTER_KEY directly if that's what your MeiliSearch instance requires
        ...
        'index-settings' => [
            ...
            Url::class => [
                'filterableAttributes' => ['id', 'url_address', 'user', 'created_at', 'updated_at'],
                'sortableAttributes' => ['updated_at', 'created_at'],
            ],
            Avatar::class => [
